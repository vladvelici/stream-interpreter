...
#
OBJS = exceptions.cmo args.cmo interpreterObjects.cmo parser.cmo lexer.cmo printer.cmo environment.cmo typechecker.ml evalHelperFunctions.ml native.cmo eval.cmo main.cmo
...
all: .depend $(DEPEND) $(OBJS) mysplinterpreter
